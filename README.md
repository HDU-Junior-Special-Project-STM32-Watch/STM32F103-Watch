...
- 2026.2.4.21:01(YXZ):上传注释(并非完整版本，出于家里的台式电脑半损坏)
- 2026.2.5.0:08(YXZ):尝试修复电脑后的一次注释版本的提交
- 2026.2.5.0:52(YXZ):在写注释时进行代码检查，修正了MPU6050读取不是连续读取的问题
- 2026.2.5.10:54(YXZ):更改按键长按时间为1000ms;增加了日期时间设置的按键长按的使用
